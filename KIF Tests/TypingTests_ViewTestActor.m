...
{
    [[[viewTester usingAccessibilityLabel:@"Greeting"] usingValue:@"Hello"] tap];
...
- (void)testEnteringTextIntoFirstResponder
{
    ...
    [[[viewTester usingAccessibilityLabel:@"Greeting"] usingValue:@"Yo"] waitForView];
}
...
{
    [[viewTester usingAccessibilityLabel:@"Greeting"] enterText:@", world" expectedResult:@"Hello, world"];
    [[[viewTester usingAccessibilityLabel:@"Greeting"] usingValue:@"Hello, world"] waitForView];
}
...
- (void)testEnteringReturnCharacterIntoViewWithAccessibilityLabel
{
    ...
    [[viewTester usingAccessibilityLabel:@"Greeting"] enterText:@", world\n" expectedResult:@"Hello, world"];
}
...
- (void)testThatClearingTextHitsTheDelegate
{
    ...
    [[[viewTester usingAccessibilityLabel:@"Greeting"] usingValue:@"Deleted something."] waitForView];
}

- (void)testThatBackspaceDeletesOneCharacter
{
    [[viewTester usingAccessibilityLabel:@"Other Text"] enterText:@"hi\bello" expectedResult:@"hello"];
    [[[viewTester usingAccessibilityLabel:@"Greeting"] usingValue:@"Deleted something."] waitForView];
}
