...
{
    [[viewTester usingAccessibilityLabel:@"Date Selection"] tap];
    ...
    [[[[viewTester usingAccessibilityLabel:@"Date Selection"] usingValue:@"Jun 17, 1965"] usingTraits:UIAccessibilityTraitNone] waitForView];
}
...
- (void)testSelectingDateInFuture
{
    ...
    [viewTester selectDatePickerValue:date];
    [[[[viewTester usingAccessibilityLabel:@"Date Selection"] usingValue:@"Dec 31, 2030"] usingTraits:UIAccessibilityTraitNone] waitForView];
}

- (void)testSelectingDateTime
{
    [[viewTester usingAccessibilityLabel:@"Date Time Selection"] tap];
    NSArray *dateTime = @[ @"Jun 17", @"6", @"43", @"AM" ];
    [viewTester selectDatePickerValue:dateTime];
    [[[[viewTester usingAccessibilityLabel:@"Date Time Selection"] usingValue:@"Sunday, Jun 17, 06:43 AM"] usingTraits:UIAccessibilityTraitNone] waitForView];
}

- (void)testSelectingTime
{
    [[viewTester usingAccessibilityLabel:@"Time Selection"] tap];
    NSArray *time = @[ @"7", @"44", @"AM" ];
    [viewTester selectDatePickerValue:time];
    [[[[viewTester usingAccessibilityLabel:@"Time Selection"] usingValue:@"7:44 AM"] usingTraits:UIAccessibilityTraitNone] waitForView];
}

- (void)testSelectingCountdown
{
    [[viewTester usingAccessibilityLabel:@"Countdown Selection"] tap];
    NSArray *countdown = @[ @"4", @"10" ];
    [viewTester selectDatePickerValue:countdown];
    [[[[viewTester usingAccessibilityLabel:@"Countdown Selection"] usingValue:@"15000.000000"] usingTraits:UIAccessibilityTraitNone] waitForView];
}
...
- (void)testSelectingRowInComponent
{
    ...
    [[[[viewTester usingAccessibilityLabel:@"Date Selection"] usingValue:@"Dec 17, 2030"] usingTraits:UIAccessibilityTraitNone] waitForView];
}
