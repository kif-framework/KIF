 ...
 */
- (void)deactivateAppForDuration:(NSTimeInterval)duration DEPRECATED_MSG_ATTRIBUTE("This method has been deprecated, use [system deactivateAppForDuration:] instead.");
