...
/*!
 ...
 @abstract A step that taps a particular view in the view hierarchy if it is found and skips otherwise.
 @discussion The view or accessibility element with the given label is searched for in the view hierarchy. If the element isn't found the step is skipped. If it isn't currently tappable, then the step will attempt to wait until it is. Once the view is present and tappable, a tap event is simulated in the center of the view or element.
...
/*!
 @method stepToTapViewIfExistsWithAccessibilityLabel:traits:
 @abstract A step that taps a particular view in the view hierarchy if it is found and skips otherwise.
 @discussion The view or accessibility element with the given label is searched for in the view hierarchy. If the element isn't found the step is skipped. If it isn't currently tappable, then the step will attempt to wait until it is. Once the view is present and tappable, a tap event is simulated in the center of the view or element.
...
/*!
 @method stepToTapViewIfExistsWithAccessibilityLabel:value:traits:
 @abstract A step that taps a particular view in the view hierarchy if it is found and skips otherwise.
 @discussion The view or accessibility element with the given label is searched for in the view hierarchy. If the element isn't found the step is skipped. If it isn't currently tappable, then the step will attempt to wait until it is. Once the view is present and tappable, a tap event is simulated in the center of the view or element.
